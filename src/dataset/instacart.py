...
class InstacartDataset(NBRDatasetBase):
    ...
    def _preprocess(self) -> pd.DataFrame:
        ...
        interactions = orders.set_index("order_id").join(order_products.set_index("order_id"), how="inner")
        interactions = interactions.reset_index().rename(columns={"order_id": "basket_id", "product_id": "item_id"})
